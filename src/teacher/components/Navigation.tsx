...
import { Home, MessageCircle, User, Star } from 'lucide-react';
...
const Navigation: React.FC<NavigationProps> = ({ activeTab, onTabChange }) => {
  const tabs = [
    ...
    { id: 'points', label: 'Points', icon: Star, color: 'bg-mint-400' },
    { id: 'profile', label: 'Profile', icon: User, color: 'bg-teal-400' },
  ];
